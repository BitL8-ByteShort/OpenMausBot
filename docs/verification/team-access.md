...
It selects Engineering and Research, proves nothing changed before Save, then
checks the saved grants and revokes Engineering. The screenshot and before/after
...
revocation, and withholding a child result if access changes mid-task. An active
