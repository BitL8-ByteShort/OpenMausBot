  ...
  it("pins legacy delegation guidance and shared staffing independently of the bounded chat coordinator", () => {
    ...
    expect(prompt).toBe(
      [
        ...
        "When the user asks you to assemble a team, use create_bot for each genuinely useful specialist. Give each one a clear role and instructions, then use the available coordination tools to assign its work. Do not create duplicate or unnecessary bots.",
