...
const fixture = vi.hoisted(() => ({ effects: [] as EffectCallback[], dispatch: vi.fn(), api: vi.fn(), create: vi.fn(), ready: false, hook: 0 }));
...
beforeEach(() => {
  ...
  fixture.ready = false; fixture.create.mockReset();
