...
const fixture = vi.hoisted(() => {
  ...
  return { dispatch: vi.fn(), platform: "other", localReasonCode: "cua-driver-unavailable", model: null as ComponentProps<typeof ModelPicker> | null,
...
vi.mock("./DesktopCapabilities", async (importOriginal) => ({
  ...
  useDesktopCapabilities: () => ({ capabilities: { dictation: { available: false }, host: { packaged: true, platform: fixture.platform }, localComputer: { available: false, reasonCode: fixture.localReasonCode } }, ready: true }),
}));
